...
%\begin{aligned}
%\partial_t \gamma_{ij} &= -2 \alpha K_{ij} + D_i \beta_j + D_j \beta_i \\
%\partial_t \gamma_{rr} &= -2 \alpha K_{rr} + D_r \beta + D_r \beta \\
%\partial_t (\psi^4) &= -2 \alpha K_{rr} + 2 \gamma_{r}^{~b} \nabla_b \beta \\
%&= -2 \alpha K_{rr} + 2 \gamma^{\mu b} \gamma_{r \mu} \nabla_b \beta \\
%&= -2 \alpha K_{rr} + 2 \gamma^{\mu r} \gamma_{r \mu} \nabla_r \beta \\
%&= -2 \alpha K_{rr} + 2 \gamma^{r r} \gamma_{r r} \nabla_r \beta \\
%4 \psi^3 \dot{\psi} &= -2 \alpha K_{rr} + 2 \beta' \\
%K_{rr} &= \frac{1}{\alpha} (\beta' - 2 \psi^3 \dot{\psi}); \\
%\end{aligned}
%\end{equation}
\begin{equation}
\begin{aligned}
...
%&= -2 \alpha K_{ij} + D_i (\gamma_{kj} \beta^{k}) + D_j (\gamma_{ik} \beta^{k}) \\
%\partial_t \gamma_{rr} &= -2 \alpha K_{rr} + D_r (\gamma_{kr} \beta^{k}) + D_r (\gamma_{rk} \beta^{k}) \\
%&= -2 \alpha K_{rr} + \gamma_{r}^{~b} \nabla_{b} (\gamma_{rr} \beta^{r}) + \gamma_{r}^{~b} \nabla_b (\gamma_{rr} \beta^{r}) \\
%&= -2 \alpha K_{rr} + 2 \gamma^{ab} \gamma_{ra} \nabla_{b} (\gamma_{rr} \beta^{r}) \\
%&= -2 \alpha K_{rr} + 2 \gamma^{rr} \gamma_{rr} \nabla_{r} (\gamma_{rr} \beta^{r}) \\
%\partial_t \psi^4 &= -2 \alpha K_{rr} + 2 \partial_{r} (\psi^4 \beta) \\
%4 \psi^3 \dot{\psi} &= -2 \alpha K_{rr} + 2 (4 \psi^3 \psi' \beta + \psi^4 \beta') \\
%K_{rr} &= \frac{1}{\alpha} \Big( 4 \psi^3 \psi' \beta + \psi^4 \beta' - 2 \psi^3 \dot{\psi} \Big) \\
\end{aligned}
\end{equation}
similarly
\begin{equation}
...
%\end{aligned}
%\end{equation}
%the other components are zero.  If we compute $R = R^{\mu}_{~\mu} = g^{\mu \nu} R_{\mu \nu}$ we get
%\begin{equation}
%\begin{aligned}
%R &= g^{\mu \nu} R_{\mu \nu} \\
%&= g^{tt} R_{tt} + g^{rr} R_{rr} + g^{\theta \theta} R_{\theta \theta} + g^{\phi \phi} R_{\phi \phi} \\
%&= 0 + (\psi^{-4} - \alpha^{-2} \beta^2) R_{rr} + \psi^{-4} r^{-2} R_{\theta \theta} + \psi^{-4} r^{-2} \sin^{-2} \theta R_{\phi \phi} \\
%&=  (\psi^{-4} - \alpha^{-2} \beta^2) \Big[- 2 \Big( \frac{2 \psi''}{\psi} - \frac{2 \psi'^2}{\psi^2}  - \frac{1}{r^2} \Big) - 2 \Big(\frac{2 \psi'}{\psi}  + \frac{1}{r}\Big)^2\Big] \\
%&+ \psi^{-4} r^{-2} \Big[ - \frac{4 \psi' r}{\psi} - \frac{2 \psi'' r^2}{\psi} + \frac{2 \psi'^2 r^2}{\psi^2} - 1 \Big] \\
%&+ \psi^{-4} r^{-2} \sin^{-2} \Big[ - \sin^2 \theta \, \Big( \frac{4 \psi' r}{\psi} + \frac{2 \psi'' r^2}{\psi} - \frac{2 \psi' r^2}{\psi^2} + 1 \Big) \Big] \\
%&=  (\psi^{-4} - \alpha^{-2} \beta^2) \Big[- \Big( \frac{4 \psi''}{\psi} - \frac{4 \psi'^2}{\psi^2}  - \frac{2}{r^2} \Big) - \Big(\frac{8 \psi'^2}{\psi^2}  + \frac{8 \psi'}{\psi r} + \frac{2}{r^2} \Big) \Big] \\
%&+ 2 \psi^{-4} \Big[ - \frac{4 \psi'}{\psi r} - \frac{2 \psi''}{\psi} + \frac{2 \psi'^2 }{\psi^2} - \frac{1}{r^{2}} \Big] \\
