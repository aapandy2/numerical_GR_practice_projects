...
\begin{equation}
\begin{aligned}
S^r &= \frac{1}{\alpha^5} \beta \dot{\Phi}^2 \left(\alpha^2 - \beta^2 \left(\psi^4 - 1\right) \right) \\
&+ \frac{1}{\alpha^5 \psi^8} \dot{\Phi} \Phi' \left(-\alpha^4 \psi^4 + \alpha^2 \beta^2 + \beta^4 \left( \psi^4 - 1 \right)^2 \psi^4 \right) \\
&+ \frac{1}{\alpha^5 \psi^8} \beta^3 \Phi'^2 \left(\psi^4 - 1\right) \left(\beta^2 \psi^4 - \alpha^2 \right).
\end{aligned}
\end{equation}
Similarly,
\begin{equation}
...
\end{aligned}
\end{equation}
we again need to pay special attention to the derivative term.  Doing it explicitly, we find
\begin{equation}
\begin{aligned}
D_r K^{rr} &= \gamma_{r}^{~b} \nabla_b K^{rr} \\
&= \gamma_{r}^{~b} (\partial_b K^{rr} + \Gamma^{r}_{b \lambda} K^{r \lambda} + \Gamma^{r}_{\lambda b} K^{\lambda r}) \\
&= \gamma_{r}^{~r} (\partial_r K^{rr} + \Gamma^{r}_{r r} K^{r r} + \Gamma^{r}_{r r} K^{r r}) \\
&= \partial_r K^{rr} + \frac{4 \psi'}{\psi} K^{r r} \\
&= \partial_r \Big[ \frac{2 \psi^{-5} \psi' \beta}{\alpha} + \frac{\psi^{-4} \beta'}{\alpha} - \frac{2 \psi^{-5}}{\alpha} \dot{\psi} \Big] + \frac{4 \psi'}{\psi} K^{r r} \\
&= \partial_r \Big[ \frac{2 \psi^{-5} \psi' \beta}{\alpha} + \frac{\psi^{-4} \beta'}{\alpha} - \frac{2 \psi^{-5} \beta \psi'}{\alpha} - \frac{2 \psi^{-5} \beta \psi}{3 r \alpha} - \frac{2 \psi^{-5} \beta' \psi}{6 \alpha} \Big] + \frac{4 \psi'}{\psi} K^{r r} \\
&= \partial_r \Big[ \frac{\psi^{-4} \beta'}{\alpha} - \frac{2 \psi^{-5} \beta \psi}{3 r \alpha} - \frac{2 \psi^{-5} \beta' \psi}{6 \alpha} \Big] + \frac{4 \psi'}{\psi} K^{r r} \\
&= \Big[ \frac{2 \beta''}{3 \psi^{4} \alpha} - \frac{8 \beta' \psi'}{3 \psi^{5} \alpha} - \frac{2 \beta' }{3 \psi^{4} r \alpha} - \frac{2 \beta' \alpha'}{3 \psi^{4} \alpha^2} + \frac{8 \beta \psi' }{3 \psi^{5} r \alpha} + \frac{2 \beta }{3 \psi^{4} r^2 \alpha} + \frac{2 \beta \alpha'}{3 \psi^{4} r \alpha^2} \Big] \\
&+ \frac{8 \psi'}{3 \psi^5 \alpha} \Big( \beta' - \frac{\beta}{r} \Big) \\
&= \frac{2 \beta''}{3 \psi^{4} \alpha} - \frac{2 \beta' }{3 \psi^{4} r \alpha} - \frac{2 \beta' \alpha'}{3 \psi^{4} \alpha^2} + \frac{2 \beta }{3 \psi^{4} r^2 \alpha} + \frac{2 \beta \alpha'}{3 \psi^{4} r \alpha^2} \\
\end{aligned}
\end{equation}
