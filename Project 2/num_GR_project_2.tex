...
\begin{figure}
	...
	\caption{Plot of $\ln(|\mathcal{R}|)$ vs. $A^*-A$, which should be linear with slope $-2\gamma$ according to equation \ref{eq:R_max_eqn}.  The plot agrees nicely with the predicted behavior.}
\end{figure}
